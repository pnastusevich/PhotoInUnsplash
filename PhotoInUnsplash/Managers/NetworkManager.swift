...
final class NetworkManager {
    ...
    func fetchRandomData(completion:  @escaping (Result<[ImageModel], NetworkError>) -> Void) {
        let parametrs = self.prepareRandomParametrs()
    ...
    private func prepareRandomParametrs() -> [String: String] {
        var parametrs = [String: String]()
        parametrs["count"] = String(30)
